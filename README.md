...
- 输出更完整的 `DESIGN.md`：视觉氛围、颜色角色、字体规则、组件样式、布局原则、深度层级、响应式行为、Agent Prompt Guide 和 Prompt Contract。
...
- Visual theme, color roles, typography rules, component stylings, layout principles, depth, responsive behavior, Agent Prompt Guide, and Prompt Contract.
